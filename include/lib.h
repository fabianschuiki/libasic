...
// LIB library version
#define LIB_VERSION_MAJOR @ASIC_VERSION_MAJOR@
#define LIB_VERSION_MINOR @ASIC_VERSION_MINOR@
#define LIB_VERSION_PATCH @ASIC_VERSION_PATCH@
#define LIB_VERSION_STRING "@ASIC_VERSION@"
...
ASIC_API const char *lib_errstr(int err);


// I/O
ASIC_API int lib_read(lib_t**, const char*);
ASIC_API int lib_write(lib_t*, const char*);


// Library
ASIC_API lib_t *lib_new(const char *name);
ASIC_API void lib_free(lib_t*);
ASIC_API int lib_add_cell(lib_t*, const char *name, lib_cell_t**);
ASIC_API lib_cell_t *lib_find_cell(lib_t*, const char *name);
ASIC_API unsigned lib_get_num_cells(lib_t*);
ASIC_API lib_cell_t *lib_get_cell(lib_t*, unsigned);
ASIC_API void lib_set_capacitance_unit(lib_t*, double);
ASIC_API void lib_set_leakage_power_unit(lib_t*, double);
ASIC_API double lib_get_capacitance_unit(lib_t*);
ASIC_API double lib_get_leakage_power_unit(lib_t*);
ASIC_API int lib_add_lut_template(lib_t*, const char*, lib_table_format_t**);
ASIC_API lib_table_format_t *lib_find_lut_template(lib_t*, const char*);


// Cell
ASIC_API int lib_cell_add_pin(lib_cell_t*, const char *name, lib_pin_t**);
ASIC_API lib_pin_t *lib_cell_find_pin(lib_cell_t*, const char *name);
ASIC_API const char *lib_cell_get_name(lib_cell_t*);
ASIC_API unsigned lib_cell_get_num_pins(lib_cell_t*);
ASIC_API lib_pin_t *lib_cell_get_pin(lib_cell_t*, unsigned);
ASIC_API void lib_cell_set_leakage_power(lib_cell_t*, double);
ASIC_API double lib_cell_get_leakage_power(lib_cell_t*);


// Pin
ASIC_API const char *lib_pin_get_name(lib_pin_t*);
ASIC_API void lib_pin_set_capacitance(lib_pin_t*, double);
ASIC_API double lib_pin_get_capacitance(lib_pin_t*);
ASIC_API lib_timing_t *lib_pin_add_timing(lib_pin_t*);
ASIC_API unsigned lib_pin_get_num_timings(lib_pin_t*);
ASIC_API lib_timing_t *lib_pin_get_timing(lib_pin_t*, unsigned);


// Timing
ASIC_API int lib_timing_add_table(lib_timing_t*, unsigned, lib_table_t**);
ASIC_API lib_table_t *lib_timing_find_table(lib_timing_t*, unsigned);
ASIC_API unsigned lib_timing_get_num_related_pins(lib_timing_t*);
ASIC_API const char *lib_timing_get_related_pin(lib_timing_t*, unsigned);
ASIC_API void lib_timing_add_related_pin(lib_timing_t*, const char*);
ASIC_API void lib_timing_set_type(lib_timing_t*, unsigned);
ASIC_API void lib_timing_set_sense(lib_timing_t*, unsigned);
ASIC_API unsigned lib_timing_get_type(lib_timing_t*);
ASIC_API unsigned lib_timing_get_sense(lib_timing_t*);
ASIC_API void lib_timing_set_scalar(lib_timing_t*, unsigned, double);
ASIC_API double lib_timing_get_scalar(lib_timing_t*, unsigned);


// Table
ASIC_API unsigned lib_table_get_num_dims(lib_table_t*);
ASIC_API unsigned lib_table_get_variable(lib_table_t*, unsigned);
ASIC_API unsigned lib_table_get_num_indices(lib_table_t*, unsigned);
ASIC_API double *lib_table_get_indices(lib_table_t*, unsigned);
ASIC_API unsigned lib_table_get_num_values(lib_table_t*);
ASIC_API double *lib_table_get_values(lib_table_t*);
ASIC_API void lib_table_set_variable(lib_table_t*, unsigned, unsigned);
ASIC_API void lib_table_set_indices(lib_table_t*, unsigned, unsigned, double*);
ASIC_API void lib_table_set_values(lib_table_t*, unsigned, double*);
ASIC_API void lib_table_set_stride(lib_table_t*, unsigned, unsigned);
